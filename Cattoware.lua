...
for i,v in pairs(game.CoreGui:GetChildren()) do
	if v.Name == 'Request Handler' or v.Name == 'Cattori Services' or v.Name == 'RBXS Lua Engine' then
	    if GamerDetected == true then else
		    SystemMessage("You have already executed Cattori.", red)
	        GamerDetected = true
	end
		else
	end
...
function loader:detectGame()
	...
	if detectedGame then
	    SystemMessage("Game detected! Loading..", green)
		return detectedGame
	else
	    SystemMessage("Unsupported Game! Loading Universal.. join the Discord to make game suggestions.", red)
...
SystemMessage("Welcome Cattori, "..game:GetService("Players").LocalPlayer.Name.."!", green)
SystemMessage("Join the Discord for more!", green)
SystemMessage("cattori.xyz/discord", yellow)
SystemMessage("Registering games, this may take minimum 15 seconds depending on your executor..", yellow)
-- games
if arch.create_secure_function or COCO_LOADED or KRNL_LOADED then
    ...
    wait(0.5)
    loader:registerGame(23144831, "CraftWars", "https://raw.githubusercontent.com/CatzCode/cat/main/Games/CraftWars.lua")
    wait(0.5)
...
SystemMessage("All games successfully registered!", green)
